...
const copy = computed(() => isEnglish.value ? {
  ...
  highlights: [
    ...
    { title: 'Google Cloud', detail: 'Certified as an Associate Cloud Engineer, specializing in cloud infrastructure development.', icon: '/icons/highlight-cloud-certification-flat.png' },
  ],
  ...
  highlights: [
    ...
    { title: 'Google Cloud', detail: 'Certificado como Associate Cloud Engineer, especialista em desenvolvimento de infraestrutura cloud.', icon: '/icons/highlight-cloud-certification-flat.png' },
  ],
