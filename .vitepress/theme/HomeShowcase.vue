...
const copy = computed(() => isEnglish.value ? {
  ...
  highlights: [
    ...
    { title: '5+', detail: 'Years of experience', icon: '/icons/highlight-experience-3d.png' },
    { title: '20+', detail: 'Projects delivered', icon: '/icons/highlight-projects-3d.png' },
  ...
  highlights: [
    ...
    { title: '5+', detail: 'Anos de experiência', icon: '/icons/highlight-experience-3d.png' },
    { title: '20+', detail: 'Projetos entregues', icon: '/icons/highlight-projects-3d.png' },
    { title: 'Google Cloud', detail: 'Associate Cloud Engineer', icon: '/icons/highlight-cloud-certification-3d.png' },
  ],
