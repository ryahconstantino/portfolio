  ...
  projects: [
    {
      ...
      description: 'A Deezer client for Windows, Linux and Android with built-in uBlock Origin Lite integration, custom cosmetic filters and native Linux features.',
      detail: 'Packages for Windows, Linux and Android, plus media controls, system tray and Wayland support.',
      image: '/personal-projects/deejazz.png',
      ...
      technologies: ['Electron', 'JavaScript', 'Windows', 'Linux', 'Android'],
      featured: true,
      discontinued: false,
    },
    {
  ...
  projects: [
    {
      id: 'deejazz',
      name: 'DeeJazz',
      eyebrow: 'Aplicativo de Músicas',
      description: 'Um cliente do Deezer para Windows, Linux e Android com integração nativa ao uBlock Origin Lite, filtros cosméticos próprios e recursos do sistema no Linux.',
      detail: 'Oferece pacotes para Windows, Linux e Android, além de controles de mídia, bandeja do sistema e suporte a Wayland.',
      image: '/personal-projects/deejazz.png',
...
.personal-project__actions a:focus-visible {
  outline: 2px solid var(--vp-c-brand-1);
  outline-offset: 3px;
}

.personal-project__actions a:active {
  transform: scale(.97);
}
